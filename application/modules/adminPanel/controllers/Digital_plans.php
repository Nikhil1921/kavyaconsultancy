...
class Digital_plans extends Admin_controller  {

	private $table = 'digital_plans';
	protected $redirect = 'digital_plans';
	protected $title = 'Digital plan';
	protected $name = 'digital_plans';
    ...
    {
        check_ajax();
        $this->load->model('Digital_plans_model', 'data');
	...
	public function add()
	{
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            $post = [
                ...
                'features'      =>  $this->input->post('features') ? implode(', ', $this->input->post('features')) : null,
	...
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            $data['url'] = $this->redirect;
            $data['data'] = $this->main->get($this->table, 'planname, validity, features, price', ['id' => d_id($id)]);
