...
<div class="card">
    ...
    <div class="card-body">
        <table class="table">
            <thead>
                <tr>
                    <th>Policy No : <?= $data['policy_no']; ?></th>
                    <th>Purchase Date : <?= date('d-m-Y', strtotime($data['purchase_date'])); ?></th>
                    <th>Expiry Date : <?= date('d-m-Y', strtotime($data['expiry_date'])); ?></th>
                </tr>
                <tr>
                    <th>Remarks</th>
                    <th>Status</th>
            ...
            <tbody>
                ...
                <?php foreach($followups as $follow): if (in_array($follow['status'], ['Completed', 'Rejected'])) $hide = true; ?>
                    <tr>
