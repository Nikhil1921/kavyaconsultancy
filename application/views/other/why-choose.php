<section id="why_choose_car_section">
  <div class="container">
    <div class="why_choose_car_head">
      <h2 class="head_clr"><span class="head_name_color">Why Choose <?= $show; ?></span> by SecureHub Consultants Private Limited?</h2>
      <p>We treat our customers like VIPs, know how…</p>
    </div>
    <div class="row why_choose_car_content">
      <div id="mediclaim_ins_crd_new" class="col-lg-4 col-md-12 col-sm-12 why_choose_car_con">
        <div id="new_add_crd" class="card crd_why_choose" style="width: 100%;">
